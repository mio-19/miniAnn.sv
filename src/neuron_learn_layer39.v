...
module neuron_learn_layer39 (
	...
	output wire [623:0] out;
	output wire [((39 * N) * 17) - 1:0] weights;
	output wire [662:0] activation_upper_bound;
	output wire [662:0] activation_lower_bound;
	input wire [623:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((39 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(39),
		.LEN(N)
	) avg(
