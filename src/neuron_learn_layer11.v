...
module neuron_learn_layer11 (
	...
	output wire [((11 * N) * 17) - 1:0] weights;
	output wire [186:0] activation_upper_bound;
	output wire [186:0] activation_lower_bound;
	input wire [175:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((11 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(11),
		.LEN(N)
	) avg(
