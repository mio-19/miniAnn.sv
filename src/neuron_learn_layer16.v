...
module neuron_learn_layer16 (
	...
	output wire [((16 * N) * 17) - 1:0] weights;
	output wire [271:0] activation_upper_bound;
	output wire [271:0] activation_lower_bound;
	input wire [255:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((16 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(16),
		.LEN(N)
	) avg(
