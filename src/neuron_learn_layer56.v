...
module neuron_learn_layer56 (
	...
	output wire [895:0] out;
	output wire [((56 * N) * 17) - 1:0] weights;
	output wire [951:0] activation_upper_bound;
	output wire [951:0] activation_lower_bound;
	input wire [895:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((56 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(56),
		.LEN(N)
	) avg(
