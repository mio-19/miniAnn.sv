...
module neuron_learn_layer60 (
	...
	output wire [959:0] out;
	output wire [((60 * N) * 17) - 1:0] weights;
	output wire [1019:0] activation_upper_bound;
	output wire [1019:0] activation_lower_bound;
	input wire [959:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((60 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(60),
		.LEN(N)
	) avg(
