...
module neuron_learn_layer6 (
	...
	output wire [((6 * N) * 17) - 1:0] weights;
	output wire [101:0] activation_upper_bound;
	output wire [101:0] activation_lower_bound;
	input wire [95:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((6 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(6),
		.LEN(N)
	) avg(
