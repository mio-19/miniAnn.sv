...
module neuron_learn_layer45 (
	...
	output wire [719:0] out;
	output wire [((45 * N) * 17) - 1:0] weights;
	output wire [764:0] activation_upper_bound;
	output wire [764:0] activation_lower_bound;
	input wire [719:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((45 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(45),
		.LEN(N)
	) avg(
