...
module neuron_learn_layer41 (
	...
	output wire [((41 * N) * 17) - 1:0] weights;
	output wire [696:0] activation_upper_bound;
	output wire [696:0] activation_lower_bound;
	input wire [655:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((41 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(41),
		.LEN(N)
	) avg(
