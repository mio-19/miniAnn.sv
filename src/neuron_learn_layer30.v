...
module neuron_learn_layer30 (
	...
	output wire [479:0] out;
	output wire [((30 * N) * 17) - 1:0] weights;
	output wire [509:0] activation_upper_bound;
	output wire [509:0] activation_lower_bound;
	input wire [479:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((30 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(30),
		.LEN(N)
	) avg(
