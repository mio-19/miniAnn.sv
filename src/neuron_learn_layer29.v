...
module neuron_learn_layer29 (
	...
	output wire [463:0] out;
	output wire [((29 * N) * 17) - 1:0] weights;
	output wire [492:0] activation_upper_bound;
	output wire [492:0] activation_lower_bound;
	input wire [463:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((29 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(29),
		.LEN(N)
	) avg(
