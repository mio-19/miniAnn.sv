...
module neuron_learn_layer23 (
	...
	output wire [367:0] out;
	output wire [((23 * N) * 17) - 1:0] weights;
	output wire [390:0] activation_upper_bound;
	output wire [390:0] activation_lower_bound;
	input wire [367:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((23 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(23),
		.LEN(N)
	) avg(
