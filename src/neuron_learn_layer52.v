...
module neuron_learn_layer52 (
	...
	output wire [831:0] out;
	output wire [((52 * N) * 17) - 1:0] weights;
	output wire [883:0] activation_upper_bound;
	output wire [883:0] activation_lower_bound;
	input wire [831:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((52 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(52),
		.LEN(N)
	) avg(
