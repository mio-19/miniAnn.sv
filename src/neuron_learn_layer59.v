...
module neuron_learn_layer59 (
	...
	output wire [943:0] out;
	output wire [((59 * N) * 17) - 1:0] weights;
	output wire [1002:0] activation_upper_bound;
	output wire [1002:0] activation_lower_bound;
	input wire [943:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((59 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(59),
		.LEN(N)
	) avg(
