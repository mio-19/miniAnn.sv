...
module neuron_learn_layer7 (
	...
	output wire [111:0] out;
	output wire [((7 * N) * 17) - 1:0] weights;
	output wire [118:0] activation_upper_bound;
	output wire [118:0] activation_lower_bound;
	input wire [111:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((7 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(7),
		.LEN(N)
	) avg(
