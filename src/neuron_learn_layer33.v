...
module neuron_learn_layer33 (
	...
	output wire [527:0] out;
	output wire [((33 * N) * 17) - 1:0] weights;
	output wire [560:0] activation_upper_bound;
	output wire [560:0] activation_lower_bound;
	input wire [527:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((33 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(33),
		.LEN(N)
	) avg(
