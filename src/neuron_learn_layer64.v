...
module neuron_learn_layer64 (
	...
	output wire [((64 * N) * 17) - 1:0] weights;
	output wire [1087:0] activation_upper_bound;
	output wire [1087:0] activation_lower_bound;
	input wire [1023:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((64 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(64),
		.LEN(N)
	) avg(
	...
	neuron_learn #(.N(N)) instance57(
		.clock(clock),
		.valid(valid),
		.learn(learn),
		.in(in),
		.out(out[912+:16]),
		.weights(weights[17 * (57 * N)+:17 * N]),
		.activation_upper_bound(activation_upper_bound[969+:17]),
		.activation_lower_bound(activation_lower_bound[969+:17]),
		.expected_out(expected_out[912+:16]),
		.expected_in(unavg_expected_in[16 * (57 * N)+:16 * N])
	);
	neuron_learn #(.N(N)) instance58(
		.clock(clock),
		.valid(valid),
		.learn(learn),
		.in(in),
		.out(out[928+:16]),
		.weights(weights[17 * (58 * N)+:17 * N]),
		.activation_upper_bound(activation_upper_bound[986+:17]),
		.activation_lower_bound(activation_lower_bound[986+:17]),
		.expected_out(expected_out[928+:16]),
		.expected_in(unavg_expected_in[16 * (58 * N)+:16 * N])
	);
	neuron_learn #(.N(N)) instance59(
		.clock(clock),
		.valid(valid),
		.learn(learn),
		.in(in),
		.out(out[944+:16]),
		.weights(weights[17 * (59 * N)+:17 * N]),
		.activation_upper_bound(activation_upper_bound[1003+:17]),
		.activation_lower_bound(activation_lower_bound[1003+:17]),
		.expected_out(expected_out[944+:16]),
		.expected_in(unavg_expected_in[16 * (59 * N)+:16 * N])
	);
	neuron_learn #(.N(N)) instance60(
		.clock(clock),
		.valid(valid),
		.learn(learn),
		.in(in),
		.out(out[960+:16]),
		.weights(weights[17 * (60 * N)+:17 * N]),
		.activation_upper_bound(activation_upper_bound[1020+:17]),
		.activation_lower_bound(activation_lower_bound[1020+:17]),
		.expected_out(expected_out[960+:16]),
		.expected_in(unavg_expected_in[16 * (60 * N)+:16 * N])
	);
	neuron_learn #(.N(N)) instance61(
		.clock(clock),
		.valid(valid),
		.learn(learn),
		.in(in),
		.out(out[976+:16]),
		.weights(weights[17 * (61 * N)+:17 * N]),
		.activation_upper_bound(activation_upper_bound[1037+:17]),
		.activation_lower_bound(activation_lower_bound[1037+:17]),
		.expected_out(expected_out[976+:16]),
		.expected_in(unavg_expected_in[16 * (61 * N)+:16 * N])
	);
	neuron_learn #(.N(N)) instance62(
		.clock(clock),
		.valid(valid),
		.learn(learn),
		.in(in),
		.out(out[992+:16]),
		.weights(weights[17 * (62 * N)+:17 * N]),
		.activation_upper_bound(activation_upper_bound[1054+:17]),
		.activation_lower_bound(activation_lower_bound[1054+:17]),
		.expected_out(expected_out[992+:16]),
		.expected_in(unavg_expected_in[16 * (62 * N)+:16 * N])
	);
	neuron_learn #(.N(N)) instance63(
		.clock(clock),
		.valid(valid),
		.learn(learn),
		.in(in),
		.out(out[1008+:16]),
		.weights(weights[17 * (63 * N)+:17 * N]),
		.activation_upper_bound(activation_upper_bound[1071+:17]),
		.activation_lower_bound(activation_lower_bound[1071+:17]),
		.expected_out(expected_out[1008+:16]),
		.expected_in(unavg_expected_in[16 * (63 * N)+:16 * N])
	);
endmodule
