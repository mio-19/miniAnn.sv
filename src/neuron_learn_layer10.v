...
module neuron_learn_layer10 (
	...
	output wire [((10 * N) * 17) - 1:0] weights;
	output wire [169:0] activation_upper_bound;
	output wire [169:0] activation_lower_bound;
	input wire [159:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((10 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(10),
		.LEN(N)
	) avg(
