...
module neuron_learn_layer19 (
	...
	output wire [303:0] out;
	output wire [((19 * N) * 17) - 1:0] weights;
	output wire [322:0] activation_upper_bound;
	output wire [322:0] activation_lower_bound;
	input wire [303:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((19 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(19),
		.LEN(N)
	) avg(
