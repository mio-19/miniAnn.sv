...
module neuron_learn_layer18 (
	...
	output wire [((18 * N) * 17) - 1:0] weights;
	output wire [305:0] activation_upper_bound;
	output wire [305:0] activation_lower_bound;
	input wire [287:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((18 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(18),
		.LEN(N)
	) avg(
