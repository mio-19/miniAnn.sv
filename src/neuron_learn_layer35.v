...
module neuron_learn_layer35 (
	...
	output wire [559:0] out;
	output wire [((35 * N) * 17) - 1:0] weights;
	output wire [594:0] activation_upper_bound;
	output wire [594:0] activation_lower_bound;
	input wire [559:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((35 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(35),
		.LEN(N)
	) avg(
