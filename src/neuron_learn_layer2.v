...
module neuron_learn_layer2 (
	...
	output wire [((2 * N) * 17) - 1:0] weights;
	output wire [33:0] activation_upper_bound;
	output wire [33:0] activation_lower_bound;
	input wire [31:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((2 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(2),
		.LEN(N)
	) avg(
