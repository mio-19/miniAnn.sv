...
module neuron_learn_layer26 (
	...
	output wire [415:0] out;
	output wire [((26 * N) * 17) - 1:0] weights;
	output wire [441:0] activation_upper_bound;
	output wire [441:0] activation_lower_bound;
	input wire [415:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((26 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(26),
		.LEN(N)
	) avg(
