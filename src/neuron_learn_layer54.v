...
module neuron_learn_layer54 (
	...
	output wire [863:0] out;
	output wire [((54 * N) * 17) - 1:0] weights;
	output wire [917:0] activation_upper_bound;
	output wire [917:0] activation_lower_bound;
	input wire [863:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((54 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(54),
		.LEN(N)
	) avg(
