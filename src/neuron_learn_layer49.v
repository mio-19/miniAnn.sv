...
module neuron_learn_layer49 (
	...
	output wire [783:0] out;
	output wire [((49 * N) * 17) - 1:0] weights;
	output wire [832:0] activation_upper_bound;
	output wire [832:0] activation_lower_bound;
	input wire [783:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((49 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(49),
		.LEN(N)
	) avg(
