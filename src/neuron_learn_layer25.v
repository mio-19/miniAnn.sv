...
module neuron_learn_layer25 (
	...
	output wire [((25 * N) * 17) - 1:0] weights;
	output wire [424:0] activation_upper_bound;
	output wire [424:0] activation_lower_bound;
	input wire [399:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((25 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(25),
		.LEN(N)
	) avg(
