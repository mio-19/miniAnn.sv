...
module neuron_learn_layer55 (
	...
	output wire [((55 * N) * 17) - 1:0] weights;
	output wire [934:0] activation_upper_bound;
	output wire [934:0] activation_lower_bound;
	input wire [879:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((55 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(55),
		.LEN(N)
	) avg(
