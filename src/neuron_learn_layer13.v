...
module neuron_learn_layer13 (
	...
	output wire [207:0] out;
	output wire [((13 * N) * 17) - 1:0] weights;
	output wire [220:0] activation_upper_bound;
	output wire [220:0] activation_lower_bound;
	input wire [207:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((13 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(13),
		.LEN(N)
	) avg(
