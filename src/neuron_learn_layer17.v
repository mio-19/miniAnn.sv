...
module neuron_learn_layer17 (
	...
	output wire [((17 * N) * 17) - 1:0] weights;
	output wire [288:0] activation_upper_bound;
	output wire [288:0] activation_lower_bound;
	input wire [271:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((17 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(17),
		.LEN(N)
	) avg(
