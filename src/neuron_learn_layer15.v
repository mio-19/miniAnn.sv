...
module neuron_learn_layer15 (
	...
	output wire [239:0] out;
	output wire [((15 * N) * 17) - 1:0] weights;
	output wire [254:0] activation_upper_bound;
	output wire [254:0] activation_lower_bound;
	input wire [239:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((15 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(15),
		.LEN(N)
	) avg(
