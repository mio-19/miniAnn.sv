...
module neuron_learn_layer34 (
	...
	output wire [543:0] out;
	output wire [((34 * N) * 17) - 1:0] weights;
	output wire [577:0] activation_upper_bound;
	output wire [577:0] activation_lower_bound;
	input wire [543:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((34 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(34),
		.LEN(N)
	) avg(
