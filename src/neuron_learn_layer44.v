...
module neuron_learn_layer44 (
	...
	output wire [703:0] out;
	output wire [((44 * N) * 17) - 1:0] weights;
	output wire [747:0] activation_upper_bound;
	output wire [747:0] activation_lower_bound;
	input wire [703:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((44 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(44),
		.LEN(N)
	) avg(
