...
module neuron_learn_layer58 (
	...
	output wire [927:0] out;
	output wire [((58 * N) * 17) - 1:0] weights;
	output wire [985:0] activation_upper_bound;
	output wire [985:0] activation_lower_bound;
	input wire [927:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((58 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(58),
		.LEN(N)
	) avg(
