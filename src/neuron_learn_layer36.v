...
module neuron_learn_layer36 (
	...
	output wire [575:0] out;
	output wire [((36 * N) * 17) - 1:0] weights;
	output wire [611:0] activation_upper_bound;
	output wire [611:0] activation_lower_bound;
	input wire [575:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((36 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(36),
		.LEN(N)
	) avg(
