...
module neuron_learn_layer37 (
	...
	output wire [591:0] out;
	output wire [((37 * N) * 17) - 1:0] weights;
	output wire [628:0] activation_upper_bound;
	output wire [628:0] activation_lower_bound;
	input wire [591:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((37 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(37),
		.LEN(N)
	) avg(
