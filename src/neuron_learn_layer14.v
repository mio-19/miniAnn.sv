...
module neuron_learn_layer14 (
	...
	output wire [((14 * N) * 17) - 1:0] weights;
	output wire [237:0] activation_upper_bound;
	output wire [237:0] activation_lower_bound;
	input wire [223:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((14 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(14),
		.LEN(N)
	) avg(
