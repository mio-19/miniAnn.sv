...
module neuron_learn_layer22 (
	...
	output wire [351:0] out;
	output wire [((22 * N) * 17) - 1:0] weights;
	output wire [373:0] activation_upper_bound;
	output wire [373:0] activation_lower_bound;
	input wire [351:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((22 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(22),
		.LEN(N)
	) avg(
