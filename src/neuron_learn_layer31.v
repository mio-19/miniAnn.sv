...
module neuron_learn_layer31 (
	...
	output wire [495:0] out;
	output wire [((31 * N) * 17) - 1:0] weights;
	output wire [526:0] activation_upper_bound;
	output wire [526:0] activation_lower_bound;
	input wire [495:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((31 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(31),
		.LEN(N)
	) avg(
