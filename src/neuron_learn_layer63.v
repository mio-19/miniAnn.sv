...
module neuron_learn_layer63 (
	...
	output wire [1007:0] out;
	output wire [((63 * N) * 17) - 1:0] weights;
	output wire [1070:0] activation_upper_bound;
	output wire [1070:0] activation_lower_bound;
	input wire [1007:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((63 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(63),
		.LEN(N)
	) avg(
