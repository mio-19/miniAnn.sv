...
module neuron_learn_layer48 (
	...
	output wire [((48 * N) * 17) - 1:0] weights;
	output wire [815:0] activation_upper_bound;
	output wire [815:0] activation_lower_bound;
	input wire [767:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((48 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(48),
		.LEN(N)
	) avg(
