...
module neuron_learn_layer39 #(
    ...
    output unit_t out [39-1:0],

    output unit_signed_t weights [39-1:0][N-1:0],
    output unit_signed_t activation_upper_bound [39-1:0],
    output unit_signed_t activation_lower_bound [39-1:0],

    input unit_t expected_out [39-1:0],
    output unit_t expected_in [N-1:0]
);

    unit_t unavg_expected_in [39-1:0][N-1:0];
    unit_arr_average #(.N(39), .LEN(N)) avg (.in(unavg_expected_in), .out(expected_in));
    ...
    neuron_learn #(.N(N)) instance28 (.clock(clock), .valid(valid), .learn(learn), .in(in), .out(out[28]), .weights(weights[28]), .activation_upper_bound(activation_upper_bound[28]), .activation_lower_bound(activation_lower_bound[28]), .expected_out(expected_out[28]), .expected_in(unavg_expected_in[28]));
    neuron_learn #(.N(N)) instance29 (.clock(clock), .valid(valid), .learn(learn), .in(in), .out(out[29]), .weights(weights[29]), .activation_upper_bound(activation_upper_bound[29]), .activation_lower_bound(activation_lower_bound[29]), .expected_out(expected_out[29]), .expected_in(unavg_expected_in[29]));
    neuron_learn #(.N(N)) instance30 (.clock(clock), .valid(valid), .learn(learn), .in(in), .out(out[30]), .weights(weights[30]), .activation_upper_bound(activation_upper_bound[30]), .activation_lower_bound(activation_lower_bound[30]), .expected_out(expected_out[30]), .expected_in(unavg_expected_in[30]));
    neuron_learn #(.N(N)) instance31 (.clock(clock), .valid(valid), .learn(learn), .in(in), .out(out[31]), .weights(weights[31]), .activation_upper_bound(activation_upper_bound[31]), .activation_lower_bound(activation_lower_bound[31]), .expected_out(expected_out[31]), .expected_in(unavg_expected_in[31]));
    neuron_learn #(.N(N)) instance32 (.clock(clock), .valid(valid), .learn(learn), .in(in), .out(out[32]), .weights(weights[32]), .activation_upper_bound(activation_upper_bound[32]), .activation_lower_bound(activation_lower_bound[32]), .expected_out(expected_out[32]), .expected_in(unavg_expected_in[32]));
    neuron_learn #(.N(N)) instance33 (.clock(clock), .valid(valid), .learn(learn), .in(in), .out(out[33]), .weights(weights[33]), .activation_upper_bound(activation_upper_bound[33]), .activation_lower_bound(activation_lower_bound[33]), .expected_out(expected_out[33]), .expected_in(unavg_expected_in[33]));
    neuron_learn #(.N(N)) instance34 (.clock(clock), .valid(valid), .learn(learn), .in(in), .out(out[34]), .weights(weights[34]), .activation_upper_bound(activation_upper_bound[34]), .activation_lower_bound(activation_lower_bound[34]), .expected_out(expected_out[34]), .expected_in(unavg_expected_in[34]));
    neuron_learn #(.N(N)) instance35 (.clock(clock), .valid(valid), .learn(learn), .in(in), .out(out[35]), .weights(weights[35]), .activation_upper_bound(activation_upper_bound[35]), .activation_lower_bound(activation_lower_bound[35]), .expected_out(expected_out[35]), .expected_in(unavg_expected_in[35]));
    neuron_learn #(.N(N)) instance36 (.clock(clock), .valid(valid), .learn(learn), .in(in), .out(out[36]), .weights(weights[36]), .activation_upper_bound(activation_upper_bound[36]), .activation_lower_bound(activation_lower_bound[36]), .expected_out(expected_out[36]), .expected_in(unavg_expected_in[36]));
    neuron_learn #(.N(N)) instance37 (.clock(clock), .valid(valid), .learn(learn), .in(in), .out(out[37]), .weights(weights[37]), .activation_upper_bound(activation_upper_bound[37]), .activation_lower_bound(activation_lower_bound[37]), .expected_out(expected_out[37]), .expected_in(unavg_expected_in[37]));
    neuron_learn #(.N(N)) instance38 (.clock(clock), .valid(valid), .learn(learn), .in(in), .out(out[38]), .weights(weights[38]), .activation_upper_bound(activation_upper_bound[38]), .activation_lower_bound(activation_lower_bound[38]), .expected_out(expected_out[38]), .expected_in(unavg_expected_in[38]));
