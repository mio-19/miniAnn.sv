...
module neuron_learn_layer40 (
	...
	output wire [((40 * N) * 17) - 1:0] weights;
	output wire [679:0] activation_upper_bound;
	output wire [679:0] activation_lower_bound;
	input wire [639:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((40 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(40),
		.LEN(N)
	) avg(
