...
module neuron_learn_layer3 (
	...
	output wire [((3 * N) * 17) - 1:0] weights;
	output wire [50:0] activation_upper_bound;
	output wire [50:0] activation_lower_bound;
	input wire [47:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((3 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(3),
		.LEN(N)
	) avg(
