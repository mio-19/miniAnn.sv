...
module neuron_learn_layer46 (
	...
	output wire [735:0] out;
	output wire [((46 * N) * 17) - 1:0] weights;
	output wire [781:0] activation_upper_bound;
	output wire [781:0] activation_lower_bound;
	input wire [735:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((46 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(46),
		.LEN(N)
	) avg(
