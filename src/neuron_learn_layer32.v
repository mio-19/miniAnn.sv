...
module neuron_learn_layer32 (
	...
	output wire [((32 * N) * 17) - 1:0] weights;
	output wire [543:0] activation_upper_bound;
	output wire [543:0] activation_lower_bound;
	input wire [511:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((32 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(32),
		.LEN(N)
	) avg(
