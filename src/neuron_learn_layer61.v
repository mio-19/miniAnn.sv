...
module neuron_learn_layer61 (
	...
	output wire [((61 * N) * 17) - 1:0] weights;
	output wire [1036:0] activation_upper_bound;
	output wire [1036:0] activation_lower_bound;
	input wire [975:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((61 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(61),
		.LEN(N)
	) avg(
