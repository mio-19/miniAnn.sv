...
module neuron_learn_layer51 (
	...
	output wire [815:0] out;
	output wire [((51 * N) * 17) - 1:0] weights;
	output wire [866:0] activation_upper_bound;
	output wire [866:0] activation_lower_bound;
	input wire [815:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((51 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(51),
		.LEN(N)
	) avg(
