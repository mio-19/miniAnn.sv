...
module neuron_learn_layer50 (
	...
	output wire [((50 * N) * 17) - 1:0] weights;
	output wire [849:0] activation_upper_bound;
	output wire [849:0] activation_lower_bound;
	input wire [799:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((50 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(50),
		.LEN(N)
	) avg(
