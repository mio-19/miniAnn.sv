...
module neuron_learn_layer47 (
	...
	output wire [751:0] out;
	output wire [((47 * N) * 17) - 1:0] weights;
	output wire [798:0] activation_upper_bound;
	output wire [798:0] activation_lower_bound;
	input wire [751:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((47 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(47),
		.LEN(N)
	) avg(
