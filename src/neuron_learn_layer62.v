...
module neuron_learn_layer62 (
	...
	output wire [991:0] out;
	output wire [((62 * N) * 17) - 1:0] weights;
	output wire [1053:0] activation_upper_bound;
	output wire [1053:0] activation_lower_bound;
	input wire [991:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((62 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(62),
		.LEN(N)
	) avg(
