...
module neuron_learn_layer27 (
	...
	output wire [431:0] out;
	output wire [((27 * N) * 17) - 1:0] weights;
	output wire [458:0] activation_upper_bound;
	output wire [458:0] activation_lower_bound;
	input wire [431:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((27 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(27),
		.LEN(N)
	) avg(
