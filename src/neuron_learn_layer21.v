...
module neuron_learn_layer21 (
	...
	output wire [((21 * N) * 17) - 1:0] weights;
	output wire [356:0] activation_upper_bound;
	output wire [356:0] activation_lower_bound;
	input wire [335:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((21 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(21),
		.LEN(N)
	) avg(
