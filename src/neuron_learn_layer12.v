...
module neuron_learn_layer12 (
	...
	output wire [((12 * N) * 17) - 1:0] weights;
	output wire [203:0] activation_upper_bound;
	output wire [203:0] activation_lower_bound;
	input wire [191:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((12 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(12),
		.LEN(N)
	) avg(
