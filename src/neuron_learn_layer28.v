...
module neuron_learn_layer28 (
	...
	output wire [((28 * N) * 17) - 1:0] weights;
	output wire [475:0] activation_upper_bound;
	output wire [475:0] activation_lower_bound;
	input wire [447:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((28 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(28),
		.LEN(N)
	) avg(
