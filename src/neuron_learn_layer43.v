...
module neuron_learn_layer43 (
	...
	output wire [687:0] out;
	output wire [((43 * N) * 17) - 1:0] weights;
	output wire [730:0] activation_upper_bound;
	output wire [730:0] activation_lower_bound;
	input wire [687:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((43 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(43),
		.LEN(N)
	) avg(
