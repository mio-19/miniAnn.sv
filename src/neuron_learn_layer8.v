...
module neuron_learn_layer8 (
	...
	output wire [((8 * N) * 17) - 1:0] weights;
	output wire [135:0] activation_upper_bound;
	output wire [135:0] activation_lower_bound;
	input wire [127:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((8 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(8),
		.LEN(N)
	) avg(
