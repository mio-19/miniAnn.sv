...
module neuron_learn_layer38 (
	...
	output wire [607:0] out;
	output wire [((38 * N) * 17) - 1:0] weights;
	output wire [645:0] activation_upper_bound;
	output wire [645:0] activation_lower_bound;
	input wire [607:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((38 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(38),
		.LEN(N)
	) avg(
