...
module neuron_learn_layer42 (
	...
	output wire [671:0] out;
	output wire [((42 * N) * 17) - 1:0] weights;
	output wire [713:0] activation_upper_bound;
	output wire [713:0] activation_lower_bound;
	input wire [671:0] expected_out;
	output wire [(N * 16) - 1:0] expected_in;
	wire [((42 * N) * 16) - 1:0] unavg_expected_in;
	unit_arr_average #(
		.N(42),
		.LEN(N)
	) avg(
